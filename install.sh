...
nohub java -jar ShortVideoProject.jar --spring.datasource.password=${mysqlpass} --server.port=${webport} &
...
mysql -uroot -p${mysqlpass}  -f shortvideo -e "source  /root/shortvideo.sql"
