                    ...
                    <div class="col-md-12 col-md-offset-0 text-left">
                        ...
                        <div class="row row-mt-15em">
                            ...
                            <div class="col-md-7 mt-text animate-box" data-animate-effect="fadeInUp">
                                ...
                                <h1>搜索详情</h1>
                                <span class="intro-text-small">下面有你刚刚搜索到的数据~</span>
                            </div>
                            ...
                            <form class="form-inline">
                                <div class="col-md-8 col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="searchinput" placeholder="请输入书名">
                                    </div>
                                </div>
...
<script type="text/javascript">
    ...
    function showBookByName() {
        $.ajax({

            url: "${pageContext.request.contextPath}/BookInfoController/showBooksByName",
            type: "post",
            data: {name: getQueryString()["name"]},
            dataType: "json",
